<form>
    ...
    <!--Question 3-->
    What's 2 + 2<br />
    <input type="radio" name="question3" id="q3-1"  value="A"/><label for='q3-1'>2 <br />
    <input type="radio" name="question3" id="q3-2"  value="B"/><label for='q3-2'>4 <br />
    <input type="radio" name="question3" id="q3-3"  Value="C"/><label for='q3-3'>7 <br />
    <div id="question3-feedback" class="answer"></div><br />
    
    <!--Question 4-->
    What state is CSUMB located in?<br />
    <input type="radio" name="question4" id="q4-1"  value="A"/><label for='q4-1'>California <br />
    <input type="radio" name="question4" id="q4-2"  value="B"/><label for='q4-2'>Colorado <br />
    <input type="radio" name="question4" id="q4-3"  Value="C"/><label for='q4-3'>Connecticut <br />
