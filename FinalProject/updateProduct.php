...
<html>
    ...
    <body>
        <form>
            ...
            <strong>Name of Movie</strong> <input type="text" class="form-control" name="productName" value =<?=$product['name']?> ><br>
            <strong>Rating</strong> <input type="text" class="form-control" name="productRating" value = <?=$product['rating']?> ><br>
            ...
            <strong>Set Image URL</strong> <input type="text" name="productImage" class="form-control" value=<?=$product['picture']?>><br>
            <strong>Price</strong> <input type="text" class="form-control" value=<?=$product['price']?> name="productPrice"/><br>
            <strong>Set Trailer URL</strong> <input type="text" name="productTrailer" class="form-control" value=<?=$product['picture']?>><br>
